...
An agent is useful in proportion to what it can reach, and reaching anything real, your email, a repository, a database, a model, means authenticating to it. So the [new kind of computer](/blog/posts/new-kind-of-computer/) needs credentials within minutes of starting any real job.
