...
The implication I actually care about is the hiring flow, and the honest version is that it doesn't exist yet. Sourcing tools are already agents, but none of them are crawling for agent cards today. This is a bet, the same one `llms.txt` was two years ago, an afternoon of work wagered on where the consumers of your professional identity are moving, except this time the consumer can ask follow-up questions. If the crawlers come, the first screen stops being a human skimming a PDF and becomes their agent interviewing mine, asking pointed questions about Kubernetes or agent orchestration and getting grounded answers at three in the morning. The people who are addressable that way get evaluated first.

Tell your agent about me.
